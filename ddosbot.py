...
bot = telebot.TeleBot('ENTER_YOUR_BOT_TOKEN')

# Admin user IDs
admin_id = {"ENTER_YOUR_CHAT_ID"}
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 181:
                ...
                response = f"bgmi bgmi Finished. Target: {target} Port: {port} Time: {time}"
        else:
...
💥 /mylogs : To Check Your Recents bgmis.
💥 /plan : Checkout Our Botnet Rates.

🤖 To See Admin Commands:
💥 /admincmd : Shows All Admin Commands.

Buy From :- @DEVELOPER_X_HUNTER
Official Channel :- https://t.me/VAWZENCONFIG
'''
